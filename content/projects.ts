...
export const projects: Project[] = [
  {
    ...
    body: [
      ...
      'Other people do reach you, but never directly and never as a profile. Answer the question of the day and the teacher may show you how someone else answered the same one, anonymously: no name, no time, no place, just two ways of seeing the same thing. If that echo moves them, they can write you a letter. A first name is shared and nothing else, no photograph and no contact details, and the teacher carries the letters between you. Declining looks exactly like silence, so nobody ever learns they were passed over.',
